package com.company.testing.test_support;

import com.company.testing.TestingApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.testing.screen")
@ContextConfiguration(classes = {TestingApplication.class, UiTestAssistConfiguration.class})
